...
SELECT subject_name, sa_th_marks
FROM subject
...
$total_marks  = $subject['sa_th_marks'] ?? 0;
...
<html>
<head>
<title>Mid Exam Marks Entry</title>
...
<form method="POST" action="save_mid_marks.php">
